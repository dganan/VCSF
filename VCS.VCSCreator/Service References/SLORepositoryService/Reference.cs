...
namespace VCS.SLORepositoryService {
    ...
    public interface ISLORepositoryService {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/ISLORepositoryService/CreateSLOFromCollaborativeSession", ReplyAction="http://tempuri.org/ISLORepositoryService/CreateSLOFromCollaborativeSessionRespons" +
            "e")]
        System.IAsyncResult BeginCreateSLOFromCollaborativeSession(string csid, string csthread, string sid, string source, string name, bool automaticCategorization, string userId, System.AsyncCallback callback, object asyncState);
    ...
    public partial class SLORepositoryServiceClient : System.ServiceModel.ClientBase<VCS.SLORepositoryService.ISLORepositoryService>, VCS.SLORepositoryService.ISLORepositoryService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult VCS.SLORepositoryService.ISLORepositoryService.BeginCreateSLOFromCollaborativeSession(string csid, string csthread, string sid, string source, string name, bool automaticCategorization, string userId, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginCreateSLOFromCollaborativeSession(csid, csthread, sid, source, name, automaticCategorization, userId, callback, asyncState);
        }
        ...
        private System.IAsyncResult OnBeginCreateSLOFromCollaborativeSession(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            string source = ((string)(inValues[3]));
            string name = ((string)(inValues[4]));
            bool automaticCategorization = ((bool)(inValues[5]));
            string userId = ((string)(inValues[6]));
            return ((VCS.SLORepositoryService.ISLORepositoryService)(this)).BeginCreateSLOFromCollaborativeSession(csid, csthread, sid, source, name, automaticCategorization, userId, callback, asyncState);
        }
        ...
        public void CreateSLOFromCollaborativeSessionAsync(string csid, string csthread, string sid, string source, string name, bool automaticCategorization, string userId) {
            this.CreateSLOFromCollaborativeSessionAsync(csid, csthread, sid, source, name, automaticCategorization, userId, null);
        }
        
        public void CreateSLOFromCollaborativeSessionAsync(string csid, string csthread, string sid, string source, string name, bool automaticCategorization, string userId, object userState) {
        ...
        private class SLORepositoryServiceClientChannel : ChannelBase<VCS.SLORepositoryService.ISLORepositoryService>, VCS.SLORepositoryService.ISLORepositoryService {
            ...
            public System.IAsyncResult BeginCreateSLOFromCollaborativeSession(string csid, string csthread, string sid, string source, string name, bool automaticCategorization, string userId, System.AsyncCallback callback, object asyncState) {
                ...
                _args[3] = source;
                _args[4] = name;
                _args[5] = automaticCategorization;
                _args[6] = userId;
